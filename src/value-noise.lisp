...
(defun noise-fill (side dim &key (mul 1.0) (thr 0.5) (seed 123456) symmetricp)
  "Fill a @c(dim)-dimensional array with a side @c(side) with a
thresholded value noise. If @c(symmetricp) is @c(T) the resulted noise
will have central symmetry."
  (declare (optimize (speed 3)))
